...
const (
	GreeterService_HelloWorld_FullMethodName = "/GreeterService/HelloWorld"
)
...
func (c *greeterServiceClient) HelloWorld(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloResp, error) {
	out := new(HelloResp)
	err := c.cc.Invoke(ctx, GreeterService_HelloWorld_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGreeterServiceServer) HelloWorld(context.Context, *HelloReq) (*HelloResp, error) {
...
func _GreeterService_HelloWorld_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
	in := new(HelloReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServiceServer).HelloWorld(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GreeterService_HelloWorld_FullMethodName,
	}
	handler := func(ctx context.Context, req any) (any, error) {
		return srv.(GreeterServiceServer).HelloWorld(ctx, req.(*HelloReq))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _GreeterService_HelloWorld_Handler,
		},
	},
