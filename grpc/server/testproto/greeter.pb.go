...
const file_greeter_proto_rawDesc = "" +
	...
	"\n" +
	"HelloWorld\x12\t.HelloReq\x1a\n" +
	".HelloRespB\x0eZ\f./;testprotob\x06proto3"
...
var file_greeter_proto_depIdxs = []int32{
	0, // 0: GreeterService.HelloWorld:input_type -> HelloReq
	1, // 1: GreeterService.HelloWorld:output_type -> HelloResp
